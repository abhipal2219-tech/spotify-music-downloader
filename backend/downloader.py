...
# Spotify Setup (Optional metadata)
...
def get_metadata(url):
    """Fetches track metadata using spotipy or yt-dlp fallback."""
    ...
    if sp and "open.spotify.com/track/" in url:
        try:
            ...
            print(f"Spotipy metadata failed: {e}")
...
def download_track(url, quality="mp3", progress_callback=None):
    """Downloads track using yt-dlp."""
